...
Refer to [the image's documentation](https://hub.docker.com/_/wordpress/#wordpress-installation) for a complete list of WordPress's config options that you can put in `wordpress_environment_variables_additional_variables`.
